...
for file in files:
    ...
    if os.environ.get('CM_DOCKER_REPO', '') != '':
        ii['cm_docker_repo'] = env['CM_DOCKER_REPO']
    if os.environ.get('CM_DOCKER_REPO_BRANCH', '') != '':
        ii['cm_docker_repo_branch'] = env['CM_DOCKER_REPO_BRANCH']
