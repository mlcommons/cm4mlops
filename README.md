...
The `mlperf-branch` of cm4mlops repository is where we have the updatd CM scripts for MLPerf inference including Automotive. The general CM scripts in this branch may not be compatible with any other project.

[Main MLPerf Inference Documentation Site](https://docs.mlcommons.org/inference/)
